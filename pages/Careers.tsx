        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-12 rounded-[4rem] shadow-xl border border-gray-100 space-y-6 hover:-translate-y-2 transition-transform">
              ...
              <h3 className="text-2xl font-black text-[#006D77]">{t('careers.hiring.nursing').split(':')[0]}</h3>
              <p className="text-gray-500 font-medium leading-relaxed">{t('careers.hiring.nursing').split(':')[1]}</p>
            </div>
            <div className="bg-white p-12 rounded-[4rem] shadow-xl border border-gray-100 space-y-6 hover:-translate-y-2 transition-transform">
              <div className="w-16 h-16 bg-[#EDF6F9] rounded-2xl flex items-center justify-center text-[#006D77]">
            ...
            <div className="bg-white p-12 rounded-[4rem] shadow-xl border border-gray-100 space-y-6 hover:-translate-y-2 transition-transform">
              ...
              <h3 className="text-2xl font-black text-[#006D77]">{t('careers.hiring.admin').split(':')[0]}</h3>
              <p className="text-gray-500 font-medium leading-relaxed">{t('careers.hiring.admin').split(':')[1]}</p>
            </div>
          </div>
        </div>
      </div>
