          ...
          <Routes>
            ...
            {menuData.flatMap((menu) =>
              menu.links
                ...
                .map((link) => {
                  const slug = link.path.replace('/', '');
                  return (
                    <React.Fragment key={link.name}>
                      <Route
                        path={link.path}
                        element={<Page slug={slug} defaultTitle={link.name} defaultContent={link.content} />}
                      />
                    </React.Fragment>
                  );
                })
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm text-gray-400">
                  ...
                  <li><Link to="/admin" className="hover:text-[#83C5BE] transition-colors">Admin Portal</Link></li>
                </ul>
              </div>
